...
CNN to predict where things are on chromosomes, using mean absolute error
as loss
"""
#import statements
...
import numpy as np
from MultDataGen import ChrGen, FiltChrGen
...
#data generators
trainGen = FiltChrGen(trainGlob, 
				  batchSize = genBatchSize, 
				  excludeStats = excludeStats)
valGen = FiltChrGen(valGlob, 
				batchSize = genBatchSize, 
				excludeStats = excludeStats)
